# Lớp tài liệu LaTeX cho môn Dự án công nghệ, Dự án khoa học VNU-UET

Đây là một lớp tài liệu (document class) để tạo ra một tài liệu Dự án công nghệ, Dự án khoa học theo đúng quy định của Trường Đại học Công nghệ, Đại học Quốc gia Hà Nội sử dụng LaTeX.
