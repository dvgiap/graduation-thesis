...
The objective of the thesis is to adapt the paper \textit{Adaptive Correlation-Weighted Intrinsic Rewards for Reinforcement Learning} into a thesis-style empirical study of how ACWI changes the behavior of intrinsic reward modules. The specific objectives are as follows:
\begin{itemize}
    ...
    \item present ACWI as a lightweight, state-dependent scaling mechanism that can wrap different intrinsic reward generators;
    \item describe the concrete implementation of ACWI with PPO and ICM while clarifying how the same formulation extends to count-based and RIDE modules;
