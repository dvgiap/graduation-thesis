...
\begin{itemize}
    ...
    \item formulate CARE as a lightweight, module-agnostic scaling layer that learns a state-dependent coefficient $\beta(s_t)$ via a correlation-based objective;
