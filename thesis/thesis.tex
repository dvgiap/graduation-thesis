...
% The `vietnam` babel package resets caption/label names at \begin{document}
% time, so preamble-level \renewcommand is overwritten.  Use \AtBeginDocument
% to run these overrides *after* babel's language hooks fire, ensuring English
% labels throughout the body while Vietnamese hyphenation patterns still load.
\AtBeginDocument{%
...
\title{Research on Intrinsic Motivation for Reinforcement Learning}
