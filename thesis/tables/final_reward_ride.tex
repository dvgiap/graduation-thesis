\begin{table}[H]
\centering
\caption[Final reward for the RIDE module.]{Final reward (mean of last 10 logged episodes, averaged over 5 seeds, $\pm$ standard deviation) for the RIDE module. Best entry per row in bold.}
