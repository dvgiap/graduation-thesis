\begin{table}[H]
\centering
\caption[Final reward for the COUNT module.]{Final reward (mean of last 10 logged episodes, averaged over 5 seeds, $\pm$ standard deviation) for the COUNT module. Best entry per row in bold.}
